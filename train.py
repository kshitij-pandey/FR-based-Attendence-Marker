...
message = tk.Label(window, text="FR based Attendence Marker" ,bg="white"  ,fg="black"  ,width=50  ,height=3,font=('avenir', 30)) 

message.place(x=200, y=20)

lbl = tk.Label(window, text="Enter ID",width=20  ,height=2  ,fg="black"  ,bg="white" ,font=('avenir', 15, 'bold')) 
lbl.place(x=400, y=200)

txt = tk.Entry(window,width=20  ,bg="black" ,fg="white",font=('avenir', 15, ' bold '))
txt.place(x=700, y=215)

lbl2 = tk.Label(window, text="Enter Name",width=20  ,fg="black"  ,bg="white"    ,height=2 ,font=('avenir', 15, ' bold ')) 
lbl2.place(x=400, y=300)

txt2 = tk.Entry(window,width=20  ,bg="black"  ,fg="white",font=('avenir', 15, ' bold ')  )
txt2.place(x=700, y=315)

lbl3 = tk.Label(window, text="Notification : ",width=20  ,fg="white"  ,bg="black"  ,height=2 ,font=('avenir', 15, ' bold ')) 
lbl3.place(x=400, y=400)

message = tk.Label(window, text="" ,bg="black"  ,fg="white"  ,width=30  ,height=2, activebackground = "black" ,font=('avenir', 15, ' bold ')) 
...
copyWrite.insert("insert", "Developed by Kshitij","", "KV BHU", "superscript")
